...
public class menu_principal extends javax.swing.JFrame {
    ...
    if(configuracion==null || configuracion.getCuentaConfiguracion()==0){
    ...
    }else if(configuracion!=null || configuracion.getCuentaConfiguracion()>=1) {
        if (configuracion.getCuentaConfiguracion() == 1) {
            tutorial menu = new tutorial(ventana, persona,configuracion);
            menu.setVisible(true);
            this.setVisible(false);
        } else if (configuracion.getCuentaConfiguracion() == 2) {
            partida_nueva juego = new partida_nueva(ventana, persona,configuracion);
            juego.setVisible(true);
            this.setVisible(false);
        } 
